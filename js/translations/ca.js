const translations = {
    ...
    hero: {
        roles: [
            'Desenvolupador iOS',
            'Entusiasta de l\'Ecosistema Apple',
            'Explorador d\'IA/ML',
            'Entusiasta de la Computació al Núvol',
            'Amant del Desenvolupament Mòbil',
            'Aprenent de Python',
            'Ment Creativa',
            'Amant del Disseny Minimalista',
    ...
    expertise: {
        ...
        cards: {
            ...
            backend: {
                ...
                description: 'Experiència amb Java Spring Boot per a serveis backend, juntament amb bases de dades SQL i NoSQL.'
            },
            cloud: {
                title: 'Núvol i Infraestructura',
                description: 'Experiència pràctica amb plataformes al núvol i gestió de servidors Linux per a projectes personals.'
            },
            ai: {
